...
const Navbar = () => {
   ...
   const hideLessonsDropDown = () => {
      setLessonsDropdown(false);
   };

   const showLessonsDropDown = () => {
      setLessonsDropdown(true);
   };
          ...
          <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
           ...
           <li
            ...
            <div
               ...
               className={`absolute z-10 ${servicesDropdown ? "block" : "hidden"} bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 top-full`}
               >
             <ul
           ...
           <li
              id="lessonsDropdownButton"
              onMouseEnter={showLessonsDropDown}
              onMouseLeave={hideLessonsDropDown}
              className="relative flex cursor-pointer ml-2 z-50 hidden md:flex"
              >
            <NavLink
               to="/lesson"
             ...
             {years.length > 0 && (
                 <div
                  ...
                  <ul
                     ...
                     aria-labelledby="lessonsDropdownButton"
                     >
                    {years.map((year) => (
                        <li key={year}>
                         <a
